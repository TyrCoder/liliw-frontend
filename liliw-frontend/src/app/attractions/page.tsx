...
const TYPE_LABELS: Record<string, string> = { heritage: 'Heritage', spot: 'Tourist Spot', dining: 'Dining', footwear: 'Footwear Store', stay: 'Stay' };
...
export default function AttractionsPage() {
  ...
  return (
    <div className="min-h-screen page-ground" suppressHydrationWarning>
      ...
      <PageBanner
        title="Attractions"
        subtitle="Discover all the amazing places to visit and explore in Liliw"
        backHref={null}
      />
