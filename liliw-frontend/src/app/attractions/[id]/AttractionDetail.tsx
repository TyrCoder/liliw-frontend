...
const TYPE_LABELS: Record<string, string> = { heritage: 'Heritage Site', spot: 'Tourist Spot', dining: 'Dining & Food', footwear: 'Footwear Store', stay: 'Accommodations' };
...
export default function AttractionDetail({ id }: { id: string }) {
  const { token } = useAuth();
