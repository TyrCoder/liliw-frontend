    ...
    <div style="background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 8px 40px rgba(11,61,145,.14)">
      <div style="background:linear-gradient(145deg,#0B3D91 0%,#1565C0 55%,#1976D2 100%);padding:36px 40px 32px">
        <table cellpadding="0" cellspacing="0" style="margin-bottom:24px"><tr>
          <td style="vertical-align:middle;padding-right:14px"><img src="${LOGO}" alt="Liliw Tourism" width="52" height="52" style="border-radius:14px;border:2px solid rgba(245,197,24,.5);display:block"/></td>
          <td style="vertical-align:middle"><p style="margin:0;font-size:10px;font-weight:800;letter-spacing:.22em;text-transform:uppercase;color:#F5C518">Liliw Tourism</p><p style="margin:3px 0 0;font-size:12px;color:rgba(255,255,255,.45)">Laguna, Philippines</p></td>
        </tr></table>
      ...
      <div style="padding:36px 40px 32px">
        ...
        <p style="color:#94A3B8;font-size:12px;text-align:center;margin:0">If you didn&rsquo;t create a Liliw Tourism account, you can safely ignore this email.</p>
      </div>
      <div style="padding:20px 40px 24px;background:#F8FAFC;border-top:1px solid #E2E8F0">
        <p style="margin:0;font-size:11px;color:#94A3B8;line-height:1.7">This is an automated message. Please do not reply to this email.<br>&copy; ${new Date().getFullYear()} Liliw Tourism &mdash; Laguna, Philippines</p>
      </div>
    </div>
  </div>
</body>
