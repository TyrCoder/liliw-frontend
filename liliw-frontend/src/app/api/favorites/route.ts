...
export async function GET(req: NextRequest) {
  ...
  if (error) {
    console.error('[favorites GET]', error.code, error.message);
...
export async function POST(req: NextRequest) {
  ...
  if (error) {
    console.error('[favorites POST]', error.code, error.message);
...
export async function DELETE(req: NextRequest) {
  ...
  if (error) {
    console.error('[favorites DELETE]', error.code, error.message);
    return NextResponse.json({ error: error.message }, { status: 500 });
  }
