...
/**
 * Contact submissions on their own. The staff inbox reads /api/admin/inbox,
 * which merges these with participation requests and event responses; this
 * stays because the reports tab counts contact messages specifically.
 */
