    ...
    <div className="min-h-screen bg-white" suppressHydrationWarning>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        >
          ...
          <h1 className="text-5xl font-bold mb-3" style={{ color: '#00BFB3' }}>🏞️ Tourist Spots</h1>
                  ...
                  <div className="p-8 rounded-2xl bg-white border border-gray-200 hover:border-gray-300 shadow-lg hover:shadow-2xl transition-all duration-300 h-full flex flex-col relative overflow-hidden cursor-pointer">
                    ...
                    <div className="relative z-10 flex-1">
                      ...
                      <div className="inline-flex items-center gap-2 mb-4 px-3 py-1 bg-green-100 text-green-700 rounded-full text-sm font-semibold">
                        ...
                        Tourist Spot {spot.attributes.category && `• ${spot.attributes.category}`}
                      </div>

                      {/* Title */}
                      <h2 className="text-2xl font-bold text-gray-900 mb-2 transition-colors">
                      ...
                      {spot.attributes.location && (
                        <div className="flex items-center gap-2 text-gray-600 mb-3">
                          ...
                          <span className="text-sm">{spot.attributes.location}</span>
                        </div>
                      )}
                        ...
                        <div className="flex items-center gap-2 mb-3">
                          {[...Array(5)].map((_, i) => (
                            <Star
                              key={i}
                              className={`w-4 h-4 ${
                                i < Math.round(spot.attributes.rating!)
